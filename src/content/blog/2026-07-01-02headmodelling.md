...
![キャラクター決定](/images/2026-07-01-02headmodelling_003.png)
...
今回はモデリングの際になぞっていくので下絵はこのぼやけた画像のままつかうことにした。
Blenderに画像を配置し常に最前面に表示されるように設定、半透明にしたら画像に合わせてモデルを作っていく。  

![キャラクター決定](/images/2026-07-01-02headmodelling_004.png)

自分は横顔を描くのが苦手かつこのStable Diffusionのモデルも綺麗な真横顔を生成するのが難しかったため横画像はなし。  
本当は真横から見た画像も用意した方がいいだろう。  

・下絵を再現するモデリング  
![キャラクター決定](/images/2026-07-01-02headmodelling_005.png)
...
・斜めから見た形の修正  
![キャラクター決定](/images/2026-07-01-02headmodelling_006.png)

斜め顔の修正については目指す絵柄の「ほっぺの膨らみ」と「あごの尖り具合」を意識すると理想のアニメ絵を3Dに落とし込みやすかった。  
鼻やあご、目の位置は見たままなのでわかりやすいが、輪郭はちょっとイラスト的な考え方が必要だった。

![キャラクター決定](/images/2026-07-01-02headmodelling_007.png)

デフォルメされたキャラクターは輪郭が５角形になり頬のところに角ができるが、斜めを向いているときに外側に現れる角（画像水色）と内側の角、正面顔の角（画像黄緑）が別物なのを間違わなければ割とどの角度から見ても可愛い輪郭が作れると思う。

![キャラクター決定](/images/2026-07-01-02headmodelling_008.png)

ゴリゴリのマッチョや骨ばった老人で考えるとわかりやすいが斜め顔の時だけ頬骨が飛び出し、それ以外の角度は頬ぼねではなくあごの根元が飛び出していることが多く、この２つがどの角度で見てもイラストらしい位置にくるように整形していくのがいいんじゃないだろうか。

・下絵トレスの落とし穴  
真正面から見た時にとにかく下絵と重なるようにモデリングしたのだがこれはちょっとミスだった。  
おそらくだがここで完全に下絵をなぞってはいけない部分がある。  

![キャラクター決定](/images/2026-07-01-02headmodelling_009.png)
